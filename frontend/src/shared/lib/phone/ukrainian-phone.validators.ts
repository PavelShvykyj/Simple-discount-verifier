...
export function ukrainianPhoneBodyFormatValidator(
...
export function ukrainianPhoneBodyValidator(control: AbstractControl): ValidationErrors | null {
  const value = String(control.value ?? '');
...
export function ukrainianPhoneNumberValidator(control: AbstractControl): ValidationErrors | null {
  const value = String(control.value ?? '');
