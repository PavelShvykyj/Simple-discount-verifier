...
| Current phase | PR-4 in progress |
...
| PR-4 | Admin Customer Profiles | in-progress | Staff customer profile list and exact phone lookup are being implemented first for code review; create, detail, and edit flows remain next. | |
