...
| Field | Value |
| --- | --- |
| Current phase | PCN-03 на review; требуется проверка на целевом мобильном браузере |
| Backend/API | `done` |
| Importer | `done` |
| Frontend | `review` |
| POS/1C | `todo` |
...
| PCN-03 | FE: ручной ввод и камера | `review` | PCN-01 API contract | 2026-07-28: tests — 18 files, 60 passed; lint — passed; build — completed with initial bundle budget warning (1.21 MB при budget 650 kB); Prettier — измененные PCN-03 FE-файлы passed, полный baseline-check выявил 100 ранее существовавших несоответствий; проверка реальной карты, тем, разрешения/отказа камеры и повторного сканирования на целевом мобильном браузере — pending |
